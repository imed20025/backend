...
const updateExample = async (req, res) => {
  ...
  //     Modifie un document selon l'id fourni.
  // Met à jour avec les nouvelles données (req.body).
  // { new: true } = renvoie le document mis à jour (pas l'ancien).
  // Si rien n’est trouvé, renvoie une erreur 404.
  // Sinon, renvoie l'objet mis à jour.
};
